        ...
        return (
            ...
            <React.Fragment>
                <div className='bgr'>
                    ...
                    <div className='text-center titl '>Thêm bác sĩ</div>
                    <div className='container pt-5'>
                        <form className="row g-3">
                            ...
                            <div className="col-md-6">
                                <label for="inputPassword4" className="form-label" id='password'><b>Password</b></label>
                            ...
                            <div className="col-md-6">
                                <label for="inputfirstName4" className="form-label" id='firstName'><b>First Name</b></label>
                            ...
                            <div className="col-md-6">
                                <label for="inputlastName4" className="form-label" id='lastName'><b>Last Name</b></label>
                            ...
                            <div className="col-6">
                                <label for="phonenumber" className="form-label" id='phoneNumber'><b>Số điện thoại</b></label>
                            ...
                            <div className="col-6">
                                <label for="inputAddress" className="form-label" id='address'><b>Địa chỉ</b></label>
                            ...
                            <div className="col-md-2">
                                <label for="inputgender" className="form-label" id='gender'><b>Giới tính</b></label>
                            ...
                            <div className="col-md-2">
                                ...
                                <label for="inputPosition" className="form-label" id='position'><b>Chức vụ</b></label>
                            ...
                            <div className="col-md-2">
                                <label for="inputState" className="form-label" id='role'><b>Bạn là</b>: </label>
                            ...
                            <div className="col-3">
                                <label for="inputimage" ><b>Tải ảnh</b></label>
